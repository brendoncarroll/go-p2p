...
func NewV1() SchemeV1 {
	...
	return SchemeV1{
		Name: MakeName("shake256", "chacha20poly1305", dualKEMName("shake256", "x25519", "sntrup4591761")),
		XOF:  xofScheme,
...
func dualKEMName(xof, left, right string) string {
	return strings.Join([]string{"dual", xof, left, right}, "-")
}
